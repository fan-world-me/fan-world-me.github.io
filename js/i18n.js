(function () {
  ...
  const T = {
    en: {
      ...
      'proj.cryptoai.desc':    'Real-time crypto trading signals powered by 10 AI models in parallel — displayed as an always-on-top floating window for Windows.',
      'about.stat5':           'LLM & AI APIs',
      'about.stat6':           'Open Source',
    ...
    ru: {
      ...
      'proj.cryptoai.desc':    'Сигналы для крипто-трейдинга в реальном времени от 10 AI-моделей параллельно — отображаются в плавающем окне поверх всех приложений Windows.',
      'about.stat5':           'LLM и AI API',
      'about.stat6':           'Открытый код',
